/**
 * AdvanceCrossStageModal — confirms advancing a cross to the next stage with
 * an optional transition note. Mirrors propagation's AdvanceStageModal.
 */

import { useState } from 'react';
import { Loader2, ChevronRight } from 'lucide-react';
import { STAGE_BY_KEY } from '../../utils/breedingStages';

export default function AdvanceCrossStageModal({
  open,
  cross,
  nextStageKey,
  onConfirm,
    ...
    >
      <div className="card p-7 max-w-md w-full" onClick={(e) => e.stopPropagation()}>
        ...
        <textarea
          ...
          placeholder="Pod started browning at the tip..."
          value={note}
